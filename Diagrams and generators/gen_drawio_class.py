...
draw_class(ax, 16.5, 19.5, 'TimetableHistory', [
    ...
    '+type : Text{regular|substitution}',
...
rel(ax, 4.7, 12.5, 10.5, 12.5, 'submitted_by', '1', '*')
rel(ax, 4.7, 12.0, 16.5, 12.0, 'assigned_faculty', '1', '*')
rel(ax, 9.7, 12.7, 16.5, 12.7, 'allocated_subject', '1', '*')
rel(ax, 4.5, 7.0, 16.5, 10.8, 'scheduled_for', '1', '*')
rel(ax, 9.7, 7.0, 16.5, 11.5, 'allocated_room', '1', '*')
rel(ax, 15.5, 11.0, 16.5, 7.5, 'triggers', '1', '*')
rel(ax, 18.75, 10.5, 18.75, 7.5, 'slot_ref', '1', '*')
...
plt.savefig('STTG_Class_Diagram.png', dpi=180, bbox_inches='tight', facecolor=BG)
